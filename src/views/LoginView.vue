...
<template>
  ...
  <div class="flex items-center justify-center min-h-screen">
    <div class="flex flex-col sm:w-1/2 md:w-1/3 lg:w-1/4 pt-10 pb-10 ps-5 pe-5 rounded-lg shadow-md bg-secondary_back-light dark:bg-secondary_back-dark">
      ...
      <input @click.prevent="login" type="submit" :value="$t('login')" class="w-full py-3 mb-5 text-btn_text-light bg-btn_back-primary rounded-2xl hover:bg-btn_back-primary_hover hover:cursor-pointer drop-shadow-md">
